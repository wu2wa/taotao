...
public class ContentController {
    ...
    @ResponseBody
    public List<CommodityResult> showContentZtree(@RequestParam(value = "id",defaultValue = "0") Long id){
        List<CommodityResult> results = itemContentService.findCommodityByAll(id);
        return results;
    }
